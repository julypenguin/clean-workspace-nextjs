...
>(({ className, inset, ...props }, ref) => <ContextMenuPrimitive.Label ref={ref} className={cn('px-8 py-6 text-sm font-semibold text-foreground', inset && 'pl-32', className)} {...props} />)
...
const ContextMenuSeparator = React.forwardRef<React.ElementRef<typeof ContextMenuPrimitive.Separator>, React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.Separator>>(
  ({ className, ...props }, ref) => <ContextMenuPrimitive.Separator ref={ref} className={cn('-mx-4 my-4 h-px bg-border', className)} {...props} />,
)
